...
const ExtraSection = () => {
    ...
    return (
        <>
            <div className="2xl:mx-auto 2xl:container mx-4 py-3">
                <div className="w-full relative flex items-center justify-center">
                    ...
                    <div className="contact-bg bg-opacity-30 bg-gray-200 md:my-16 lg:py-16 py-10 w-full md:mx-12 md:px-12 px-4 flex flex-col items-center justify-center relative z-40">
                        ...
                        <div className="sm:border border-white flex-col sm:flex-row flex items-center lg:w-5/12 w-full mt-12 space-y-4 sm:space-y-0">
                            <input className="border border-gray-500 text-base w-full font-medium leading-none  p-4 focus:outline-none bg-transparent " placeholder={user?.email ? user.email : "Email Address"} />
            ...
            <iframe
                ...
                height={400} style={{ border: 0 }} allowFullScreen="" loading="eager" className='w-full'
